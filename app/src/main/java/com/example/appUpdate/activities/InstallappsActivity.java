...
public class  InstallappsActivity extends AppCompatActivity {
    ...
    private static ArrayList<ItemClass> getInstalledApps(InstallappsActivity installappsActivity) {
...
//                    continue;
//                }
                installappsActivity.counter++;
                Log.d("j_value", "outer" + i);

                ItemClass newInfo = new ItemClass();
                newInfo.appname = p.applicationInfo.loadLabel(installappsActivity.getPackageManager()).toString();
                ...
                newInfo.icon = p.applicationInfo.loadIcon(installappsActivity.getPackageManager());
...
Admenager admenager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        admenager.load_InterstitialAd("admobe_interestitial_installed_app_back","admobe_interestitial_installed_app_back_test");
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle("Installed App");
        }
...
//        splashCheck = sp.getInt("splash_check", 1);
    ...
    private static void createNativeAd(InstallappsActivity installappsActivity) {
...
//
   ...
   public static class  InstalledAppsDB extends AsyncTask<Void, Void, Void> {
        ...
        private final WeakReference<InstallappsActivity> activityReference;

        // only retain a weak reference to the activity
        InstalledAppsDB(InstallappsActivity context) {
            activityReference = new WeakReference<>(context);
        }

        @Override
        protected void onPreExecute() {
            InstallappsActivity installappsActivity=activityReference.get();


            installappsActivity.progressBar.setIndeterminate(true);
            installappsActivity.progressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected Void doInBackground(Void... voids) {
            ...
            installappsActivity.myList = getInstalledApps(installappsActivity); /* false = no system packages */
            installappsActivity.myAdapter.setList(installappsActivity.myList);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            installappsActivity.pleasewait.setVisibility(View.GONE);
            installappsActivity.recyclerView.setLayoutManager(installappsActivity.layoutManager);
            installappsActivity.recyclerView.setAdapter(installappsActivity.myAdapter);
          installappsActivity.  progressBar.setVisibility(View.GONE);
            installappsActivity.editSearchView.setVisibility(View.VISIBLE);
            createNativeAd(installappsActivity);
